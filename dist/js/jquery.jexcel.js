    ...
    var methods = {
        ...
        createTable: function () {
            ...
            for (var i = 0; i < options.colHeaders.length; i++) {
                ...
                // Header
                var header = title !== null ? title : $.fn.jexcel('getColumnName', i);
        ...
        setData: function (data, ignoreSpare) {
            ...
            for (j = 0; j < $.fn.jexcel.defaults[id].data.length; j++) {
                ...
                var title = options.rowHeaders[j];

                // Header
                var header = title !== null ? title : parseInt(j + 1);

                // Index column
                $(tr).append('<td class="jexcel_label">' + header + '</td>');
        ...
        shiftFormulaByColumn: function (value, index) {
            ...
            // Elements
            var elements = formula.match(regex).filter(function (n) {
                return n != ''
            }).sort(function (a, b) {
